...
namespace BlankBrains.Inventory
{
    ...
    public class InventorySlot
    {
        ...
        public InventorySlot(ItemPickUp itemPickUp, int amount, Transform equipeItemPosition, Transform dropItemPosition)
        {
            m_ItemPickup = itemPickUp;

            m_ItemData = m_ItemPickup.item;
            m_StackSize = amount;
        ...
        public void UpdateSlot(ItemPickUp itemPickUp, int amount)
        {
            m_ItemPickup = itemPickUp;
        ...
        {
            m_ItemPickup.GetComponent<ItemController>().OnUnequipped();
        ...
        public void DropItem()
        {
            ...
            m_ItemPickup.GetComponent<ItemController>().OnItemDroppedFromInventory(m_DropItemPos);
