...
namespace SceneBookmarks
{
    ...
    {
        internal const int THUMBNAIL_WIDTH = 320;
        internal const int THUMBNAIL_HEIGHT = 180;
        private const string NO_SCENE_NAME = "NoScene";

        private static string ThumbnailPath
        {
            get { return $"{SceneBookmarkSettings.AssetDir}/Thumbnails"; }
        }
        ...
        public static void DeleteThumbnail(string scenePath, string name)
        {
            ...
            AssetDatabase.DeleteAsset($"{ThumbnailPath}/{scenePath}/{name}.png");
